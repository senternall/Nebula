...
public partial class MapInfoContainer : Panel, ISkinnable
{
	...
	public void UpdateSkin(SkinProfile skin = null)
	{
		...
		speedPresets.GetNode("MinusMinusMinus").GetNode<SpeedPresetButton>("SpeedPresetButton").Icon = skin.SpeedPresetMinusMinusMinusButtonImage;
		...
		speedPresets.GetNode("PlusPlusPlus").GetNode<SpeedPresetButton>("SpeedPresetButton").Icon = skin.SpeedPresetPlusPlusPlusButtonImage;
		speedPresets.GetNode("PlusPlusPlusPlus").GetNode<SpeedPresetButton>("SpeedPresetButton").Icon = skin.SpeedPresetPlusPlusPlusPlusButtonImage;
	}
