...
public partial class SkinProfile : GodotObject
{
	...
	public ImageTexture SpeedPresetMinusMinusMinusButtonImage { get; set; } = new();
	...
	public ImageTexture SpeedPresetPlusPlusPlusButtonImage { get; set; } = new();
	
	public ImageTexture SpeedPresetPlusPlusPlusPlusButtonImage { get; set; } = new();
